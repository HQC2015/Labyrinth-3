namespace Labyrinth.Common
{
    public class Messages
    {
        ...
        public const string DefaultGameCommandsMessage = "Use 'top' to view the top players\n'restart' to start a new game\n'exit' to quit the game.";
        public const string EnterMoveMessage = "Enter your move: ";
        public const string MoveCommandsMessage = "Move Commands:";
        public const string DefaultCommandsMessage = "Default Commands:";
        public const string InvalidCommandMessage = "Invalid command!";
        public const string ScoreboardEnterNicknameMessage = "Please enter your nickname";
